    ...
    view_ladrilhos.click(function() {
        if ($('#preview-ladrilho')[0].innerHTML == "") {
            ...
            if(testFaixas.id === 'faixas'){
                ...
                var html_inner_ladrilhos_ajustado = html_inner_ladrilhos.replace(/432px/g, '640px');
                var item_ladrilhos = '<div class="item-rejunte"><div class="holder">' + html_inner_ladrilhos_ajustado + '</div></div>';
                inner_rejuntes.html(item_ladrilhos);
